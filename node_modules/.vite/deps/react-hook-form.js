...
function useFieldArray(props) {
  ...
  const [fields, setFields] = import_react.default.useState(disabled ? [] : control._getFieldArray(name));
  const ids = import_react.default.useRef(disabled ? [] : control._getFieldArray(name).map(generateId));
